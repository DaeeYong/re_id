...
####variables####
roi_pp11_path = '/Users/ivory/Documents/1/roi/' #전처리 전 roi 폴더
pre_roi_path = '/Users/ivory/Documents/1/pre_roi/' #전처리 후 roi 폴더
...
for task in task_list:
    roi_json = roi_pp11_path + task + '.json'
    ...
    json_file_path = pre_roi_path + ppxx_list[PPXX_IDX] + '/' + task + '.json'
