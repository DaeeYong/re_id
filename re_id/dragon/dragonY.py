...
def get_results_tracking_data_from_model(video_path):
...
'''
def get_xywh_from_all_frame_data(all_frame_data_list, current_frame_num, id_idx):
        
        #data가 비어있는 프레임인 경우
        if(all_frame_data_list[current_frame_num][0]['id'] == -1):
            return -1, -1, -1, -1
        
        center_x = (all_frame_data_list[current_frame_num][id_idx]['xywh'][0])
        center_y = (all_frame_data_list[current_frame_num][id_idx]['xywh'][1])
        w = (all_frame_data_list[current_frame_num][id_idx]['xywh'][2])
        h = (all_frame_data_list[current_frame_num][id_idx]['xywh'][3])
